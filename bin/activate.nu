...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/media/driskimaulana/New Volume/UPI/SEMESTER 4/DPBO/Python/hunian_project'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/media/driskimaulana/New Volume/UPI/SEMESTER 4/DPBO/Python/hunian_project/bin/deactivate.nu'
